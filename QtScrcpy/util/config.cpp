...
#define COMMON_USE_ROOT_KEY "UseRoot"
#define COMMON_USE_ROOT_DEF false
...
void Config::setUserBootConfig(const UserBootConfig &config)
{
    ...
    m_userData->setValue(COMMON_USE_ROOT_KEY, config.useRoot);
...
UserBootConfig Config::getUserBootConfig()
{
    ...
    config.useRoot = m_userData->value(COMMON_USE_ROOT_KEY, COMMON_USE_ROOT_DEF).toBool();
